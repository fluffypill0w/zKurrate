# https://github.com/serengil/crypto/blob/master/python/EdDSA.py
...
employeeName = "Bob"
amount = 7000
amountAsText = codecs.decode(amount.to_bytes(4, byteorder='little'))

text = (employerName + employeeName + amountAsText)
